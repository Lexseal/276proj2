...
class DemoSetup:
    ...
    def load_robot(self, **kwargs):
        ...
        self.robot: sapien.Articulation = loader.load(
            kwargs.get("urdf_path", "panda.urdf")
        )
        self.robot.set_root_pose(
            sapien.Pose(
                kwargs.get("robot_origin_xyz", [0, 0, 0.2]),
    ...
    def setup_planner(self, **kwargs):
        ...
        self.planner = mplib.Planner(
            urdf=kwargs.get("urdf_path", "panda.urdf"),
            # srdf=kwargs.get("srdf_path", "panda.srdf"),
            move_group=kwargs.get("move_group", "pizza_peel"),
        )
...
if __name__ == "__main__":
    ...
    demo.load_robot()
    demo.setup_planner()
    # print out all the joints in order
    for joint in demo.planner.user_joint_names:
        print(joint)
    demo.move_to_pose(Pose([0.5, 0, 0.8], [1, 0, 0, 0]))
    # demo.move_to_pose(Pose([0.5, 0.5, 0.8], [1, 0, 0, 0]))
    # demo.move_to_pose(Pose([0, 0.5, 0.8], [1, 0, 0, 0]))
